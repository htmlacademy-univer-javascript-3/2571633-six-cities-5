...
import { AppRoute, favoriteObject } from '../../types/types';
...
export function OfferFavoriteCard ({offer, cardcssname, setActiveOffer}: OfferCardProps): JSX.Element{
